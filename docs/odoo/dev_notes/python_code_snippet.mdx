...
def serialize_datetime(self, input_datetime, source_tz_name=""):
    """
    ...
    if not source_tz_name:
        source_tz_name = "UTC"
    return self.convert_datetime_timezone(input_datetime, source_tz_name, "UTC")

def convert_datetime_timezone(self, input_datetime, source_tz_name="UTC", target_tz_name="UTC"):
    """
    ...
    source_datetime = source_tz.localize(input_datetime)
